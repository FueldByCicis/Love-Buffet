...
class SadDad(Character):
    ...
    def question1(self):
        ...
        resB = "Yeah I have a whole bottle in my bag.It's almost empty though." ##correct
        resC = "No"
        resD = "I don't believe in pharmaceuticals. Illness is a mental state. Think differently."

    def question2(self):
         question = "Do they have coffee here?"
         resA = "They'd better. I'll die without a cup." ##correct
    ...
    def question5(self):
        ...
        resC = "I get all of my sweaters from Khols!" ##correct
